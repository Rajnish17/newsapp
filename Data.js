const data = [
  {
    ...
    img: "https://thumbs.dreamstime.com/b/gold-bitcoin-coins-paypal-logo-background-screen-new-type-business-finance-concept-156665462.jpg",
    text: ` After rolling out the ability to buy and sell crypto on its platform
        in October 2020, PayPal is finally allowing users the ability to
        natively transfer, send and receive digital assets between PayPal
        and other wallets and exchanges. As of Tuesday, the feature is
        available to select U.S. users, with the feature expanding to all
        eligible U.S. users in the coming weeks. The first batch of
...
The company is also working to integrate other forms of cryptocurrency services, such as central bank digital currencies, to boost its digital footprint. It is also exploring the possibility of launching its own stablecoin, dubbed "PayPal Coin." The discovery came after a developer found evidence of such a stablecoin within the source code of the company's iPhone app.`,
  },
  {
    ...
    uppertext:"Prime Minister Giorgia Meloni's new bill also includes an incentive for those declaring crypto for tax purposes.",
    img:"https://media.istockphoto.com/id/1313455188/photo/businessman-is-holding-a-bitcoin-as-part-of-a-business-network-cryptocurrency-blockchain.jpg?b=1&s=170667a&w=0&k=20&c=HAp1wDtN1ZpHTg6cSbTPJC2yXi0cTRL5WdL7HLqeLJ4=",
    text: `Crypto traders in Italy will be subject to a 26% capital-gains tax starting in 2023, according to a new budget that won parliamentary approval on Thursday.
  ...
  },
  {
    ...
    uppertext:"Microstrategy is now holding approximately 132,500 bitcoin following its most recent purchases. This year, the world’s largest cryptocurrency has emerged as “the institutional-grade digital asset,” said Microstrategy founder Michael Saylor.",
      
    img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQDaEAT6P1WwY6eD1bjaSestaqPs7aF2t05zt2F37xr5J-St0NYdy7QbqN1CL-bogtxUeA&usqp=CAU",
    text:`Microstrategy has increased its bitcoin holdings by ~2,500 BTC. As of 12/27/22 Microstrategy holds ~132,500 bitcoin acquired for ~$4.03 billion at an average price of ~$30,397 per bitcoin.
  ...
  },
  {
    ...
    uppertext:"2022 has been a rough and tough year for investors, traders, cryptocurrency businesses, and miners in general. The prolonged bear market, exacerbated by a series of catastrophic events, posed a threat to miners.",
      
    img:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBPK2jWoZlqUJBj3A2iHGMRs0iYvnwWTWwFOzx3cR5&s",
    text: `Miners were dealing with a variety of issues, including defaulted loans, quarterly losses, and soaring bitcoin hashrates that reached all-time highs. All these factors were affecting the profitability of the miners and were causing sell pressure.
  ...
  },
  {
    ...
    uppertext:"The investor drained $110 million in cryptocurrencies from the platform.",
      
    img:"https://thumbs.dreamstime.com/z/police-officers-arresting-criminal-two-car-vector-illustration-flat-cartoon-style-189682545.jpg",
    text: `Avraham Eisenberg, the crypto investor whose “highly profitable trading strategy” drained DeFi trading platform Mango Markets of crypto worth $110 million, was arrested Monday in Puerto Rico, court documents said.
